"""QuantLinear — wraps nn.Linear / AFFNet LinearLayer with weight + input-activation fake-quant.

Mirrors QuantConv2d: weight observer runs observe+freeze once in __init__, activation
observer starts DISABLED and is driven by the calibration pass. Bias stays FP32.
